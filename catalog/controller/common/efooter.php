...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['egeser_url_prefabrik_yapilar'] = $this->url->link('product/category', 'path=59');
		...
		$data['egeser_url_ofis_yonetim'] = $this->url->link('product/category', 'path=59_62');
		$data['egeser_url_yatakhane'] = $this->url->link('product/category', 'path=59_63');
		$data['egeser_url_yemekhane'] = $this->url->link('product/category', 'path=59_64');
		$data['egeser_url_santiye'] = $this->url->link('product/category', 'path=59_65');
		$data['egeser_url_sosyal_tesis'] = $this->url->link('product/category', 'path=59_66');
		$data['egeser_url_ozel_proje'] = $this->url->link('product/category', 'path=59_67');
