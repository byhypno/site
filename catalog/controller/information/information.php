...
class ControllerInformationInformation extends Controller {
	public function index() {
		...
		if ($information_info) {
			...
			if ($information_id === 9) {
				// EGESER - Gercek proje fotograflari admin > Extensions > Modules > "Egeser Referanslari"
				// uzerinden eklendiginde bu blok otomatik gorunur; hic proje eklenmemisse bos doner.
