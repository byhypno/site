...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $egeser_ocmod_cleanup; ?>" data-toggle="tooltip" title="EGESER OCMOD Final Temizlik" class="btn btn-danger"><i class="fa fa-shield"></i></a> <a href="<?php echo $egeser_ocmod_audit; ?>" data-toggle="tooltip" title="EGESER Tam OCMOD Denetimi" class="btn btn-success"><i class="fa fa-stethoscope"></i></a> <a href="<?php echo $egeser_ocmod_test; ?>" data-toggle="tooltip" title="EGESER OCMOD Test Paneli" class="btn btn-primary"><i class="fa fa-flask"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" class="btn btn-info"><i class="fa fa-refresh"></i></a> <a href="<?php echo $clear; ?>" data-toggle="tooltip" title="<?php echo $button_clear; ?>" class="btn btn-warning"><i class="fa fa-eraser"></i></a>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right"><a href="<?php echo $modification['test']; ?>" data-toggle="tooltip" title="Güvenli A/B Test" class="btn btn-primary"><i class="fa fa-flask"></i></a> <?php if ($modification['link']) { ?>
