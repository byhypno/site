              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'title') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'date_published') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['blog_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><img src="<?php echo $blog['thumb']; ?>" class="img-thumbnail" style="width: 40px; height: 40px;" /></td>
                  <td class="text-left"><?php echo $blog['title']; ?></td>
                  <td class="text-left"><?php echo $blog['date_published']; ?></td>
                  <td class="text-left"><?php echo $blog['status']; ?></td>
                  <td class="text-right">
                    <a href="<?php echo $blog['view']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
