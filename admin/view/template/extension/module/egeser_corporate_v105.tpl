...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-building"></i> Kurumsal İçerik Kurulumu</h3></div>
      <div class="panel-body">
        ...
        <?php } else { ?>
          <div class="alert alert-warning">Kurumsal bilgi sayfası bulunamadı. Önce V10.1 Site Skeleton kaydının mevcut olduğunu kontrol edin.</div>
        <?php } ?>
      </div>
    </div>
  </div>
