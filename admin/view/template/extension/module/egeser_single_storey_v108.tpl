...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-home"></i> Tek Katlı Prefabrik Evler SEO Kurulumu</h3></div>
      <div class="panel-body">
        <p><?php echo $text_intro; ?></p>
        <?php if ($found) { ?>
        <div class="well">
          <strong>Bulunan kategori:</strong> category_id=<?php echo $category_id; ?> — <?php echo $current_name; ?><br>
          <strong>Mevcut meta title:</strong> <?php echo $current_meta_title ? $current_meta_title : '-'; ?><br>
          <strong>Mevcut açıklama:</strong> <?php echo $has_description ? 'Var' : 'Boş'; ?>
        </div>
        ...
        <?php } else { ?>
        <div class="alert alert-warning">Tek Katlı Prefabrik Evler kategorisi bulunamadı.</div>
        <?php } ?>
      </div>
    </div>
  </div>
