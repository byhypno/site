...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-cogs"></i> Teknik Bilgiler İçerik Kurulumu</h3></div>
      <div class="panel-body">
        ...
        <?php } else { ?>
          <div class="alert alert-warning">Teknik Bilgiler sayfası bulunamadı. Önce V10.1 Site Skeleton kaydının mevcut olduğunu kontrol edin.</div>
        <?php } ?>
      </div>
    </div>
  </div>
